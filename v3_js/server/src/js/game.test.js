...
import { fr, invFr, ROOK, DEFAULT_POSITION_STRING, TEST_POSITION_STRING, loadPosition, positionToString, Game, newGameWithMoves, move, getMoves, GameStatus, GameOverReason, } from "./game.js";
...
test("Moves are correctly calculated - test position", () => {
    ...
    [
        ...
        const foundMove = moves.find((key) => {
